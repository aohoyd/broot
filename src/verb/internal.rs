...
Internals! {
    ...
    copy_from_staging: "copy all staged files to the current directory" true,
    close_panel_cancel_if_not_last: "close the panel, not using the selected path, if it's not the only panel" false,
    close_panel_ok: "close the panel, validating the selected path" false,
    close_panel_ok_if_not_last: "close the panel, validating the selected path, if it's not the only panel" false,
    close_preview: "close the preview panel" false,
    close_staging_area: "close the staging area panel" false,
    copy_file_content: "copy file content to system clipboard" true,
    copy_line: "copy selected line (in tree or preview)" true,
    copy_name: "copy file name to system clipboard" true,
    ...
    move_from_staging: "move all staged files to the current directory" true,
    ...
    open_sort_overlay: "open the sort overlay" false,
    ...
    focus_panel_left: "cycle panel focus to left" false,
    focus_panel_right: "cycle panel focus to right" false,
    panel_left: "focus or open panel on left" false,
    panel_left_no_open: "focus panel on left, if any" false,
    panel_right: "focus or open panel on right" false,
    panel_right_no_open: "focus panel on right, if any" false,
